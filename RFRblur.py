    ...
    for i in range(pad_num, m - pad_num):
        for j in range(pad_num, n - pad_num):
            for k in range(pad_num, n - pad_num):
                ...
                tv2=np.sum( ttt1) / (filter_size ** 3-1)
                print(tv1,tv2)
                output_image[i, j,k] =tv2
...
if __name__=='__main__':
    blur('RFR_Interpolation_result15_9well_unblur.txt','RFR_Interpolation_result15_9well_blur.txt',1)
